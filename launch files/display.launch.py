...
def generate_launch_description():
    pkgPath = launch_ros.substitutions.FindPackageShare(package='urdf_test').find('urdf_test') #Input package here
    urdfModelPath = os.path.join(pkgPath, 'urdf/testbed.urdf') #Input urdf file here
